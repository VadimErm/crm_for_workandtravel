...
else if (FORUM_PAGE == 'viewtopic')
{
	...
	// $forum_head['loginza'] = '<script src="//loginza.ru/js/widget.js" type="text/javascript"></script>';
}
...
$gen_elements['<!-- forum_navlinks -->'] = '<ul>'."\n\t\t".generate_navlinks()."\n\t".'</ul>'.
	'<div class="search navbar__search pull-right"><form action=""><div class="form-group"><input type="text" class="search__input" id="" name=""><input type="submit" class="search__submit"></div></form></div>';
