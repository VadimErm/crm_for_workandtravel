<ul class="nav side-menu">
    ...
    <li><a><i class="fa fa-users"></i> Applications <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
            ...
            <li><a href="<?= \yii\helpers\Url::to(['student/new']) ?>">Applicants</a></li>
            <li><a href="<?= \yii\helpers\Url::to(['student/index']) ?>">Participants</a></li>
        </ul>
    </li>
    ...
    <li><a><i class="fa fa-sitemap"></i> Site <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
            <li><a href="<?= \yii\helpers\Url::to(['program/add']) ?>">Pages</a></li>
        </ul>
    </li>
