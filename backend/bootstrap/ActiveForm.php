...
class ActiveForm extends \yii\widgets\ActiveForm
{
    ...
    const FIELD_OPTIONS = ['template' => "{label}\n<div class='col-md-9 col-sm-9 col-xs-12'>{input}</div>\n{hint}\n{error}",
                           'labelOptions' => [ 
     ...
     */
    public function field($model, $attribute, $type='long')
    {
    ...
    case 'long':
        ...
        break;
    case 'short':
        $options['template'] = "{label}\n<div class='col-md-3 col-sm-3 col-xs-3'>{input}</div>\n{hint}\n{error}";
        break;
    }        
